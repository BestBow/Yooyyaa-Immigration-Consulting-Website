...
function TermsAndPrivacy() {
    return (
        <div className="container mx-auto p-4">
            ...
            <h2 className="text-4xl font-semibold text-center">Our Privacy Policy</h2>
            ...
            <div className="privacy-section mt-8">
            <h2 className="text-4xl font-semibold text-center">Terms of Service</h2>
            ...
            <div className="legal-disclaimers mt-8">
            ...
            <div className="legal-disclaimer mt-8">
            ...
            <h2 className="text-2xl font-semibold mt-8">Have questions about our terms or privacy policy? Contact us today.</h2>
            <form className="mt-4">
                <div className="mb-4">
